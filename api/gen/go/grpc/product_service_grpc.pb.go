...
type ProductServiceClient interface {
	...
	GetProductInfo(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductReply, error)
}
...
func (c *productServiceClient) GetProductInfo(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductReply, error) {
...
type ProductServiceServer interface {
	// RPC to get product info by ID
	GetProductInfo(context.Context, *ProductRequest) (*ProductReply, error)
...
func (UnimplementedProductServiceServer) GetProductInfo(context.Context, *ProductRequest) (*ProductReply, error) {
